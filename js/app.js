...
navItems.forEach(function (items) {
  navsLink.insertAdjacentHTML(
    "beforeend",
    '<a class="active-select" href="./items.html?item=' +
      items.item +
      '"><div class="about-me rounded shadow-sm text-center"><h1>' +
      items.title +
      '</h1><span class="icon-nav">' +
      items.icon +
      "</span></div></a>"
  );
  navbar.insertAdjacentHTML(
    "beforeend",
    `          <a href="./items.html?item=${items.item}">
...
section2.forEach(function (section2) {
  sectionTwo.insertAdjacentHTML(
    ...
    '<img src="' +
      ...
      '" alt="profile-img" /><h1>' +
      section2.titleMe +
      '</h1><p>توسعه دهنده وب سایت های پویا</p><p class="p-about">سلام من ابوالفضل استیری هستم دانشجوی رشته فیزیک مهندسی دانشگاه گیلان و سه سال است که در این حوزه فعالیت میکنم و مایل هستم نمونه کار ها و پروژه های خودم را با شما به اشتراک بذارم :)</p><button><a href="./assets/resumePdf/estiriResume.pdf" download style="color: white;">دانلود رزومه</a></button><div class="social-icons"><a href="https://instagram/e.abolfazl.s"><i class="bi bi-instagram"></i></a><a href="https://t.me/Abol727"><i class="bi bi-telegram"></i></a><a href="https://github.com/AbolfazlEs2006"><i class="bi bi-github"></i></a><a href="https://www.linkedin.com/in/abolfazl-estiri-a0b8b12b6"><i class="bi bi-linkedin"></i></a></div>'
  );
});
